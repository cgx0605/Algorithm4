									...
									<c:forEach items="${courses}" var="course" varStatus="loop">
										...
										<tr>
											...
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/select/findGradeDesc.do?courseId=${course.courseId}" class="btn bg-olive btn-xs">成绩详情</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>

								...
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建"
											...
											<i class="fa fa-file-o"></i> 新增学生
										</button>
										<button type="button" class="btn btn-default" title="刷新"
												onclick="location.href='${pageContext.request.contextPath}/student/findAll.do'">
									...
									<c:forEach items="${students}" var="student">
										...
										<tr>
											...
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/student/findById.do?id=${student.studentId}" class="btn bg-olive btn-xs">编辑</a>
												<a href="${pageContext.request.contextPath}/select/findselectByStudentId.do?id=${student.studentId}" class="btn bg-olive btn-xs">选课情况</a>
												<a href="${pageContext.request.contextPath}/student/deleteStudent.do?id=${student.studentId}" class="btn bg-olive btn-xs">删除</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
